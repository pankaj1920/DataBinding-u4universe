package com.example.databindingu4universe.fragment_databinding.ecomm.adapter
...
import com.example.databindingu4universe.databinding.ProductListItemBinding
import com.example.databindingu4universe.fragment_databinding.ecomm.ProducItemClickListner
...
class ProductsItemAdapter(
    ...
    RecyclerView.Adapter<ProductsItemAdapter.MyViewHolder>() {
...
//        holder.binding.productItem = product
        ...
        holder.binding.setVariable(BR.listner,context as ProducItemClickListner)
